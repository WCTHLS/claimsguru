...
-- =====================================================
-- 0. Identity, Organizations, and Access Control
-- Keycloak remains the credential authority; this schema stores the
-- application profile linked to the Keycloak/OIDC subject.
-- =====================================================
CREATE TABLE users (
...
CREATE TABLE patient_profiles (
    ...
    insurer_id UUID REFERENCES organizations(id) ON DELETE SET NULL,
...
CREATE INDEX idx_patient_profiles_insurer_id ON patient_profiles(insurer_id);
