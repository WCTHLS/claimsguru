...
const T: Record<LangCode, Dict> = {
  en: {
    ...
    "chat.placeholderIdle":     "Ask ClaimsGuru — ICD-10, CPT, risk analysis, compliance…",
    ...
    /* SSO */
    "sso.signIn":               "Sign in to ClaimsGuru",
  ...
  hi: {
    ...
    "chat.placeholderIdle":     "ClaimsGuru से पूछें — ICD-10, CPT, जोखिम विश्लेषण, अनुपालन…",
    ...
    /* SSO */
    "sso.signIn":               "ClaimsGuru में साइन इन करें",
  ...
  bn: {
    ...
    "sso.signIn":          "ClaimsGuru-এ সাইন ইন করুন",
  ...
  te: {
    ...
    "sso.signIn":          "ClaimsGuru లోకి సైన్ ఇన్ చేయండి",
  ...
  mr: {
    ...
    "workspace.title":     "दावा कार्यक्षेत्र",
    "sso.signIn":          "ClaimsGuru मध्ये साइन इन करा",
  ...
  ta: {
    ...
    "sso.signIn":          "ClaimsGuru இல் உள்நுழைக",
  ...
  ur: {
    ...
    "sso.signIn":          "ClaimsGuru میں سائن ان کریں",
  ...
  gu: {
    ...
    "action.reject":       "નકારો",
    "sso.signIn":          "ClaimsGuru માં સાઇન ઇન કરો",
  ...
  kn: {
    ...
    "sso.signIn":          "ClaimsGuru ಗೆ ಸೈನ್ ಇನ್ ಮಾಡಿ",
  ...
  or: {
    ...
    "sso.signIn":          "ClaimsGuru ରେ ସାଇନ ଇନ କରନ୍ତୁ",
  ...
  pa: {
    ...
    "sso.signIn":          "ClaimsGuru ਵਿੱਚ ਸਾਈਨ ਇਨ ਕਰੋ",
  ...
  ml: {
    ...
    "sso.signIn":          "ClaimsGuru-ലേക്ക് സൈൻ ഇൻ ചെയ്യുക",
  ...
  as: {
    ...
    "sso.signIn":          "ClaimsGuru-ত ছাইন ইন কৰক",
  ...
  sa: {
    ...
    "sso.signIn":          "ClaimsGuru-मध्ये प्रवेशं कुरुत",
